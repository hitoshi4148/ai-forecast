 ...
 */
export function calculateDollarSpotRisk(dailyData) {
 ...
 * @returns {number|null} 0〜100のリスク値（データ不足の場合はnull）
 */
export function calculateBrownPatchRisk(hourlyData) {
 ...
 * @returns {number|null} 0〜100のリスク値（データ不足の場合はnull）
 */
export function calculatePythiumRisk(dailyData) {
  if (!dailyData || dailyData.length === 0) return null;
 ...
 * @returns {number|null} 0〜100のリスク値（データ不足の場合はnull）
 */
export function calculateAnthracnoseRisk(dailyData) {
  if (!dailyData || dailyData.length === 0) return null;
 ...
 * @returns {number|null} 0〜100のリスク値（データ不足の場合はnull）
 */
export function calculateLargePatchRisk(dailyData) {
  if (!dailyData || dailyData.length === 0) return null;
 ...
 */
export function calculateAllDiseaseRisks(weatherData) {
