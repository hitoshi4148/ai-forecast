...
/**
 * User-Agent文字列（MET Norwayの利用規約で必須）
 * 実際のアプリケーション名と連絡先に変更してください
 */
const USER_AGENT = process.env.MET_NORWAY_USER_AGENT || 'DiseaseRiskForecastApp/1.0 (contact@example.com)';
